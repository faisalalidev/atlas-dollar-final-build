                                    ...
                                    <table width="33.33%" border="0" cellpadding="0" cellspacing="0" align="left" class="col">
                                        ...
                                        <tr>
                                            <td style="font-size: 14px; font-family: 'Arial', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; padding-right:15px; display:inline-block;">
                                                ...
                                                {{ $address ? $address->first_name.' '.$address->last_name : '-' }}</strong> <br>
                                                @if($address && $address->address)
                                                    {{ $data->billedTo[0]->address1 }},
                                                @endif
                        ...
                        <table width="90%" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
                            ...
                            @foreach($data->products as $line => $product)
                                <tr>
                                    ...
                                    <td style="font-size: 15px; font-family: 'Arial', sans-serif; color: #646a6e;  line-height: 18px;  vertical-align: top; padding:10px 0;padding-right: 8px;">{{ $product->inventory->description }}</td>
                                    ...
                                    <td style="font-size: 15px; font-family: 'Arial', sans-serif; color: #646a6e;  line-height: 18px;  vertical-align: top; padding:10px 0;padding-right: 8px;">{{ $product->quantity }}</td>
                                    <td style="font-size: 15px; font-family: 'Arial', sans-serif; color: #646a6e;  line-height: 18px;  vertical-align: top; padding:10px 0;padding-right: 8px;">{{ $product->quantity }}</td>
                                    ...
                                    <td style="font-size: 15px; font-family: 'Arial', sans-serif; color: #646a6e;  line-height: 18px;  vertical-align: top; padding:10px 0;padding-right: 8px;">{{ addCurrencyToPrice((double)$product->price * (int)$product->quantity) }}</td>
                                    <td style="font-size: 15px; font-family: 'Arial', sans-serif; color: #646a6e;  line-height: 18px;  vertical-align: top; padding:10px 0;text-align: right;">{{ addCurrencyToPrice((double)$product->price * (int)$product->quantity) }}</td>
                                </tr>
                                <tr>
                                    ...
                                    <table width="40%" border="0" cellpadding="0" cellspacing="0" align="right" class="fullPadding">
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-size: 16px; font-family: 'Arial', sans-serif; color: #000; line-height: 26px; vertical-align: top; text-align:right; white-space:nowrap;font-weight: bold;" width="80">
                                                {{ addCurrencyToPrice($data->getTotalAmount()) }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-size: 16px; font-family: 'Arial', sans-serif; color: #646a6e; line-height: 26px; vertical-align: top; text-align:right; ">
