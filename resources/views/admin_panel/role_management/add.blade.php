                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="mb-4">
                                ...
                                <input value="{{ old('role_name') }}" type="text" class="form-control"
                                        ...
                                        <tr>
                                            ...
                                            <td class="checkbox-column">
                                                <div
                                                    ...
                                                    <input checked
                                                           name="permissions[{{ $module->module_slug }}][can_add]"
                                                           type="checkbox"
                                                           class="custom-control-input todochkbox"
                                            ...
                                            <td class="checkbox-column">
                                                <div
                                                    class="custom-control custom-checkbox checkbox-primary">
                                                    <input checked
                                                           name="permissions[{{ $module->module_slug }}][can_edit]"
                                                           type="checkbox"
                                                           class="custom-control-input todochkbox"
                                            ...
                                            <td class="checkbox-column">
                                                <div
                                                    class="custom-control custom-checkbox checkbox-primary">
                                                    <input checked
                                                           name="permissions[{{ $module->module_slug }}][can_delete]"
                                                           type="checkbox"
                                                           class="custom-control-input todochkbox"
                                            ...
                                            <td class="checkbox-column">
                                                <div
                                                    class="custom-control custom-checkbox checkbox-primary">
                                                    <input checked
                                                           name="permissions[{{ $module->module_slug }}][can_view]"
                                                           type="checkbox"
                                                           class="custom-control-input todochkbox"
