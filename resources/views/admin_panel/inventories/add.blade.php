    ...
    <div class="container-fluid">
        ...
        <div class="row heading-bg">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h5 class="txt-dark">Add {{ $page_title }}</h5>
            </div>
            <!-- Breadcrumb -->
                ...
                <div class="panel panel-default card-view">
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="form-wrap">
                                <form action="{{ route(config('constants.ADMIN_PREFIX') . $module_name . '_add') }}"
                                      method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ old('part_number') }}" id="part_number"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control" id="price" name="price"
                                                           required value="{{ old('price') }}" placeholder="Price">
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ old('supplier_part_number') }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ old('size1') }}" id="size1"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ old('weight') }}" id="weighti"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ old('size3') }}" id="size3"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ old('in_stock') }}" id="in_stock"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea id="description2"
                                                          ...
                                                          placeholder="Description">{{ old('description2') }}</textarea>
                                                ...
                                                <div class="radio-list">
                                                    <div class="radio-inline pl-0">
                                                        <div class="radio radio-info">
                                                            <input
                                                                {{ old('status') == 'publish' ? 'checked' : '' }} type="radio"
                                                                name="status"
                                                    ...
                                                    <div class="radio-inline">
                                                        <div class="radio radio-info">
                                                            <input
                                                                {{ old('status') == 'draft' ? 'checked' : '' }} type="radio"
                                                                name="status"
                                        ...
                                        <div class="col-sm-12 ol-md-12 col-xs-12">
                                            <div class="form-group mb-4">
                                                ...
                                                <input type="file"
                                                       ...
                                                       data-default-file="{{ asset('admin_assets/img/default-product-image.png') }}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="seprator-block"></div>
